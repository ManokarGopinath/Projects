...
import googlemaps
gmaps = googlemaps.Client(key='AIzaSyAb0Sui6VjVTCqC_IeBCkLRSg7HcNsM7VE')
        ...
        if form.is_valid():
            ...
            try:
                ...
                mapdata = Mapsdata.objects.create(
                    ...
                    mapzip=adress_zip,)
                mapdata.save()
                addressdatasets = {'form': form,  'links':mapurldata,'searchingaddress':searchingaddress, 'adresscity':adress_city, 'adressstate':adress_state, 'addresscountry':adress_country, 'adresszip':adress_zip}
                ...
                try:
                    ...
                    geolocator = Nominatim(user_agent="AIzaSyAb0Sui6VjVTCqC_IeBCkLRSg7HcNsM7VE")
        ...
        if form.is_valid():
            ...
            try:
                ...
                mapdatasets = Locationdata.objects.create(
                    ...
                    addressdata=addressoveralldata,)
                mapdatasets.save()
                
                # addressdatasets = {'form': form,  'links':mapurldatas, 'address':addressoveralldata}
                return render(request, 'map.html', {'form': form,  'links':mapurldatas, 'address':addressoveralldata})
            except:
                #print("An exception occurred")
                # errortext = 'Plesae provide a valid URL'
                # longurl = ''
